...
vim.keymap.set("n", "<leader>td", require("dapui").toggle, opts)
...
vim.keymap.set("n", "<leader>dp", require("dap").pause, opts)
vim.keymap.set("n", "<leader>dl", require("dap").list_breakpoints, opts)
vim.keymap.set("n", "<leader>dx", require("dap").clear_breakpoints, opts)
vim.keymap.set("n", "<leader>dK", require("dapui").float_element, opts)
