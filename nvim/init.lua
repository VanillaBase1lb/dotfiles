...
vim.keymap.set('t', '<Esc><Esc>', '<C-\\><C-n>', { desc = 'Exit terminal mode, use <C-[> twice' })
...
require('lazy').setup {
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      require('which-key').register {
        ...
        -- ['<leader>p'] = { name = '[W]orkspace', _ = 'which_key_ignore' },
      }
    end,
  },
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>ss', function()
        builtin.grep_string {
          search = '',
          only_sort_text = true,
          prompt_title = 'Fuzyy String Search',
        }
      end, { desc = 'Fuzzy [S]tring [S]earch in all files' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>lps', require('telescope.builtin').lsp_dynamic_workspace_symbols, '[W]orkspace [S]ymbols')
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>e', require('nvim-tree.api').tree.toggle, { desc = 'NvimTree Toggle' })
    end,
  },
  'tpope/vim-surround',
  {
